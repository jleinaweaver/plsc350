...
3. [**International Institutions for Coordination**]{style="color:blue;"}
...
4. [**International Institutions for Aggregate Effort**]{style="color:blue;"}
...
![](Images/13_1-IPCC_Cover.png){style="display: block; margin: 0 auto"}
...
```{r, fig.retina=3, fig.align='center', out.width='100%', fig.width=9, fig.height=4.5, cache=FALSE}
...
![](Images/13_1-cumulative-co-emissions.svg){style="display: block; margin: 0 auto"}
...
![](Images/13_1-cumulative-co-emissions.svg)
...
![](Images/13_1-Kyoto_Preamble.png){style="display: block; margin: 0 auto"}
...
[**Kyoto Protocol: Annex B Emission Commitments**]
...
**Australia: The Politics of an Emissions Cut**

![](Images/13_1-Australia_Land_Clearing.webp){style="display: block; margin: 0 auto"}
...
![](Images/13_1-CDM_Logo.jpg){style="display: block; margin: 0 auto"}
...
[**Next Class: Effectiveness of the Kyoto Protocol**]
