...
These three figures present the findings from the regression analyses as marginal effects plots.

- Figures 1, 3 and 5 here focus on the effect of increasing a TCCs PTO score
    - Remember, PTS runs 1-5 and the higher the number the more human rights violations by the government against the people

- The y-axes represent the count of reported misconduct cases in a given country for a given year

- The top-middle Figure is the predicted count of category 1 violations including SEAs

- The bottom-left figure is the predicted count of category 1 violations excluding SEAs

- The bottom-right is the count of lesser abuses

<br>

What do we learn from these results?

### First, describe the results to me. What do we see?

- All three curves include positive slopes

- All three jump around PTS > 2

<br>

### Now go deeper, try analyzing these figures.

- Y-axis scales differ quite a bit (magnitude of crimes per type differ considerably) 

- Confidence interval spreads differ across the types

- Why do none of the plots include the highest PTS scores?
...
These three figures repeat the last three but now the x-axis is differing levels of corruption.

- Higher numbers = less corrupt
...
background-image: url('libs/Images/12_1-UN_Peacekeeping.jpg')
background-size: 100%
background-position: center
class: top, center

.size45[.content-box-white[**How should we reform UN peacekeeping?**]]

???

Ok, let's hear your reform proposals!
