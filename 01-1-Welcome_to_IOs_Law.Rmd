...
- Investigate our Prior Knowledge
...
### Prep for Class
1. OPEN class 14-3 OR just save the notes in RStudio so you can save all prior knowledge lists from class brainstorming today
...
.size65[.center[.content-box-purple[**What are your priors re: international law?**]]]
...
knitr::include_graphics("libs/Images/01_1-Slavery_Convention_Art1.png")
```
...
knitr::include_graphics("libs/Images/01_1-Slavery_Convention_Art5.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = '65%'}
knitr::include_graphics("libs/Images/01_1-Slavery_Convention_Art2.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = '65%'}
knitr::include_graphics("libs/Images/01_1-Slavery_Convention_Art6.png")
```
...
knitr::include_graphics("libs/Images/01_1-LRTAP_Art1.png")
```
...
```{r, echo = FALSE, fig.align = 'center', out.width = '95%'}
knitr::include_graphics("libs/Images/01_1-LRTAP_Art3_4.png")
```
