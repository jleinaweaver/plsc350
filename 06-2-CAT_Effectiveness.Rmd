...
.size40[**The Convention Against Torture (CAT)**]
...
### Key takeaways from last class on the CAT?
...
For today you read the arguments to three attempts to evaluate the effectiveness of the NPT.
...
.right-column[
```{r, fig.retina=3, fig.align='center', fig.asp=.65, out.width = '95%'}
tibble(
  Torture = c(rep(0, 8)),
...
.pull-left[
```{r, fig.retina=3, fig.align='center', fig.asp=.9, out.width = '100%', fig.width=6}
# Torture 0 vs 1 vs 5 vs 9
tibble(
  Torture = c(rep(0, 8), rep(1,8), rep(5,8), rep(9,8)),
  Opposition = rep(1:8, 4),
