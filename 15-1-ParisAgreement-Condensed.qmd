...
**IV. International Institutions for Aggregate Effort**
...
## {background-image="./Images/13_1-UNFCCC_Conference.png" .center}
...
## {background-image="./Images/13_1-Kyoto_Conference.png" .center}
...
```{r, cache=FALSE, fig.retina=3, fig.asp=0.618, fig.align='center', out.width='92%'}
...
## The Paris Agreement (2015) {background-image="./Images/background-scales_justice_v3.png" .center}
...
5. [**And effectiveness too!**]{style="color:blue;"}
...
## How has the science changed? {background-image="./Images/background-scales_justice_v3.png" .center}

:::: {.columns}
::: {.column width="50%"}
![](Images/13_1-IPCC_Cover.png)
:::

::: {.column width="50%"}
![](Images/14_1-IPCC_Report.png)
:::
::::
...
```{r, fig.retina=3, fig.align = 'center', out.width = '54%', fig.width=9, fig.height=4.5, cache=FALSE}
d10 |>
  mutate(
...
[**How have emission levels changed?**]
...
## {background-image="./Images/14_1-PA_Design_Old1.png" .center}
...
## {background-image="./Images/14_1-PA_Design_Old3.png" .center}
...
[**Winners and Losers of the Paris Agreement (Dimitrov 2016)**]
...
[**Key provisions of the Paris Agreement (Dimitrov 2016)**]
...
## Treaty Design Analysis {background-image="./Images/background-scales_justice_v3.png" .center}
...
## {background-image="./Images/14_1-Carbon_Capture_v2.png" .center}
...
## {background-image="./Images/14_1-Carbon_Capture_v3.png" .center}
...
## Today: Evaluating the NDCs {background-image="./Images/background-scales_justice_v3.png" .center}

![](Images/14_1-Assignment.png){style="display: block; margin: 0 auto"}
...
## NDCs: Descriptive Analyses {background-image="./Images/background-scales_justice_v3.png" .center}

![](Images/14_1-NDC_Registry.png){style="display: block; margin: 0 auto"}
...
[**Treaty Design: Top-Down vs Bottom-up**]

:::: {.columns}
::: {.column width="50%"}
![](Images/14_1-Kyoto_Cover.png)
:::

::: {.column width="50%"}
![](Images/14_1-NDCs_Logo_FAO_v2.png)
:::
::::
...
[**The Climate Watch NDC Enhancement Tracker**]

[https://www.climatewatchdata.org/2020-ndc-tracker]

![](Images/14_2-NDC_Tracker.png)
...
[**Evaluating the Climate Negotiation Groups' NDCs**]
...
**Evidence of common framings, positions, policies or demands?**
...
## {background-image="./Images/14_1-Brandt_Line_Map.jpg" .center}
...
![](Images/14_2-LeinaweaverThomson2021_1.png)

**Follow-on Work in Progress**
...
![](Images/14_1-Topic_Proportions.gif){style="display: block; margin: 0 auto"}
...
![](Images/14_2-LeinaweaverThomson_Targets.png){style="display: block; margin: 0 auto"}
...
![](Images/14_2-2022_NDC_Synthesis_Report_Figure 1.png){style="display: block; margin: 0 auto"}
...
![](Images/14_2-2022_NDC_Synthesis_Report_Figure 4 v2.png){style="display: block; margin: 0 auto"}
...
:::: {.columns}
::: {.column width="50%"}
![](Images/14_2-LeinaweaverThomson_FA1.png)
:::

::: {.column width="50%"}
![](Images/14_2-LeinaweaverThomson_FA2.png)
:::
::::
...
![](Images/14_2-LeinaweaverThomson_Map2.png){style="display: block; margin: 0 auto"}
...
![](Images/14_2-LeinaweaverThomson_Map3.png){style="display: block; margin: 0 auto"}
...
![](Images/14_2-LeinaweaverThomson_Map2.png)

![](Images/14_2-LeinaweaverThomson_Map3.png)
