...
.size50[**Today's Agenda: The UN system has problems...**
- Horne, Robinson & Lloyd (2020)
- Binder & Heupel (2015)
- Dreher, Lang, Rosendorff & Vreeland (2022)
]
...
.center[.content-box-blue[.size50[What is the United Nations?]]]

???

### At this point, what is our sense of the UN? 

### - If someone asked you what the UN is, what would you tell them?
...
.center[.size45[.content-box-white[**What is the United Nations (UN)?**]]]
...
5. Economic, Social & Cultural Council (ECOSOC)
...
The UN is kind of an umbrella term for a BUNCH of very different institutions!

### Where on the legalization table running from hard to soft law would we place each of these international institutions? Why?

<br>

### Bottom line, how much power has been delegated to the UN?

<br>

For the last few weeks we've been analyzing the design and effectiveness of the UN.

- This week I want to talk problems and possible reforms to address them.
...
Comments made in Feb of this year as an example of common criticisms of the UN you hear on cable news or coming out of Congress.
...
1. Countries that violate human rights can get onto the Human Rights Commission because that's how it was designed
    - Weirdly, that's a feature of the system and not a bug. The states are the principal and the UN is the agent! That's how delegation works in international law!

    - A UN that doesn't invite "bad" states to the table couldn't do the things we ask it to do.

    - OPINION: Criticizing the UN (global forum for problem-solving) for not being NATO (just our friends can play) is kind of stupid.

2. We have to pay for things we want in the world and the Human Rights Council budget is miniscule
    - Human Rights Council baseline budget was $133 million in 2022, US portion approx $29 million [OHCHR](https://www.ohchr.org/en/about-us/funding-and-budget)
    ...
    - OPINION: $29 million is a number so small most Congresspeople ignore it if it were to pay for ANYTHING else. Heck, in FY2023 the US House budgeted $810 million as an allowance for House members to run their offices ([FY2023 deets](https://demandprogress.org/legislative-branch-funding-breakdown-in-the-fy-2023-omnibus-bill/)) which represents a $35 million increase from last year.
...
For today you read three research arguments that identify serious problems with the UN in useful ways!
...
Group 1 present Horne, Robinson & Lloyd (2020) argument.
...
.center[.size30[.content-box-white[**HRL (2020): Model to Test**]]]
...
- Best: "...to gain operational experience, national prestige, or moral influence at the
UN or to equip troops at the UN’s expense (Bellamy and Williams 2010, 58–65)."
...
.center[.size30[.content-box-white[**HRL (2020): 1) Sources & 2) Operationalizations**]]]

.size30[
**Outcome Variable: Military Peacekeeper Misconduct**
- Peacekeeper Attribute Project (PKAT) Dataset
- Annual count in 3 types:
    - Category 1 SEA: Crimes of a sexual nature
    - Category 1 Non-SEA: Felony-type crimes
    - Category 2: Lesser abuses

**Predictor Variables**
- Political Terror Scores for the PKO
    - Levels 1 (the good) to 5 (the bad)
- Control of Corruption scores for the PKO
...
*Many of these notes come from separate Appendix (saved in Readings folder)*
...
.center[.content-box-white[.size40[**HRL (2020): 3) Analysis**]]]
...
- Unit of analysis is mission year (n = 151)

Appendix A
- "The vast majority of allegations, about 73 percent of the total since 2007, fall into Category 2. About 42 percent of mission years reported no Category 1 allegations (including SEAs); slightly fewer than half of all observations reported no Category 1 allegations of any kind. By contrast, only about one-third of observations reported no Category 2 allegations" (237).
...
.center[.content-box-white[.size30[**HRL (2020): 3) Analysis**]]]
...
.size65[**Next Class: Let's reform the UN!**]
