...
- 3.IAEA oversight of non-nuke states development of nuclear power (this is pretty strict oversight and a dramatic interference in the power of non-nuclear states)

- 4.Guarantee access to /development of peaceful nuclear power (may be interpreted as a limit on the obligations in 1-3)

- 5. ? Be open to sharing access for science ?

- 6. Consider undertaking negotiations to end nuke arms race

- 7. Regional bans on nukes are allowed (is this here to limit powers in Art 4 + 5)

- 8. Amendments allowed but SO MANY HOOPS to jump through they are basically impossible

- 9. Signature and ratification

- 10. Withdrawal only takes 3 mos and a statement that doesn't require oversight or approval

- 11. Languages and the role of the UN
