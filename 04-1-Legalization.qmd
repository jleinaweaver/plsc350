...
2. Track treaty coding in document: ...350-IOs_and_Law/2026-Fall/CODING-The_Slavery_Convention.txt
...
- [A tool for justifying the actions of states outside their borders (Grotius)]{style="color:blue;"}

- [A substantial body of rules underpinned by coherent principles built through state practice (Cassese and Hollis)]{style="color:blue;"}

- [An intervening variable for explaining outcomes (Mearsheimer)]{style="color:white;"}

- [A set of tools meant to facilitate policy coordination (Keohane)]{style="color:white;"}

::: notes

Focus for the moment on the contrast between Grotius and the legal scholars, Cassese and Hollis

- **What measurable outcomes in the world could we collect that would help us settle this debate?**
...
**SLIDE**: How about Mearsheimer's theory?
...
- [A tool for justifying the actions of states outside their borders (Grotius)]{style="color:white;"}

- [A substantial body of rules underpinned by coherent principles built through state practice (Cassese and Hollis)]{style="color:white;"}

- [An intervening variable for explaining outcomes (Mearsheimer)]{style="color:blue;"}
...
- [A set of tools meant to facilitate policy coordination (Keohane)]{style="color:blue;"}
