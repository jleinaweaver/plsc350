...
### How significant are the obligations in the Kyoto Protocol?

<br>

### How precise are the rules?

<br>

### How substantial is the delegation?

<br>

### Bottom line, is the Kyoto Protocol "hard" or "soft" law?

<br>

### Anything else from last class you want to discuss before we dig into your analyses?
...
**SLIDE**: Arguably, if we were going to turn our work this week into a research paper we would need to establish at least three key points
...
Our first job is to make clear that the outcome data we have is appropriate for the research question we are trying to answer.
...
- We need to make an argument that our chosen outcome variable, changes in emissions, usefully represents the kinds of actions incentivized by the Kyoto Protocol

- The Kyoto Protocol was aimed at encouraging a broad array of climate actions by states: reporting, financing, technology transfers, etc.

### - Do we believe the sum of these climate actions equals changes in emissions levels? Why or why not?

<br>

In terms of empirics:

- We need to demonstrate that our chosen outcome variable, changes in emissions, actually varies across the states in the sample.
...
**SLIDE**: Let's keep going with this!
...
Groups, dive into this first question and get ready to report back.
...
**IMPORTANT**: Always investigate your outliers!
...
(*OPTIONAL*) Everybody try making a histogram of ghg_2012

- **SLIDE**: Let's visualize the entire outcome variable
...
Groups, dive into this second question and get ready to report back.
