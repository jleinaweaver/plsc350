...
2. Open the CODING notes in the main folder for the Slavery convention
...
- (I think two or three of these four sound perfectly comfortable coming out of a realist's mouth)

- Transaction costs and risk aversion come very close to capturing the cheating and relative gains concerns important to Mearsheimer

- Rational design is a problem if it requires the pursuit of "joint" gains

- Shadow of the future is almost certainly a deal-breaker
...
- Must have been a severe distribution problem: Broad membership, Lots of flexibility

<br>

**Does Table 1 suggest something they could have tried to improve the effectiveness of the Slavery Convention?**

- (If the problem is distribution, then broaden the scope!)

- e.g. find new issues important to the non-participants that they do care about!
