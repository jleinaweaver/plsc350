...
[**Evaluating the Effectiveness of the Kyoto Protocol**]
...
![](Images/13_2-EG_Oil_Production.png){style="display: block; margin: 0 auto"}
...
```{r, fig.retina=3, fig.asp=0.618, fig.align='center', out.width='92%', cache=FALSE}
# Visualize 2012
...
## {background-image="./Images/background-scales_justice_v3.png" .center}
[**2) Did treaty participants see bigger declines in emissions?**]
...
knitr::include_graphics("Images/13_2-Baetting_Cover.png")
```
...
## {background-image="./Images/13_2-Baettig_oldslide3.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide5.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide7.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide13.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide9.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide10.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide11.png" .center}
...
## {background-image="./Images/13_2-Baettig_oldslide12.png" .center}
...
[**Next Class: The Paris Agreement**]
