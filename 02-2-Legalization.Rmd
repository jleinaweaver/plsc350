...
### Prep for Class
1. Full article notes in Zotero and distributed among slides below

<br>

Let's start today by reviewing how far we've come already!

- **SLIDE**: Art 38 of The Statute of the ICJ
...
c. the .textblue[**general principles of law**] recognized by civilized nations; 
...
knitr::include_graphics("libs/Images/02_2-Slavery_Convention_Cover.png")
```
]

.pull-right[
```{r, echo = FALSE, fig.align='center', out.width = '100%'}
knitr::include_graphics("libs/Images/02_2-UNGA_Moratorium_Death_Penalty.png")
```
]
...
background-image: url('libs/Images/02_2-whaling.jpg')
background-size: 100%
background-position: center

```{r, echo = FALSE, fig.align='right', out.width = '50%'}
knitr::include_graphics("libs/Images/02_2-IWC-logo.png")
```
...
.pull-left[
```{r, echo = FALSE, fig.align='center', out.width = '100%'}
knitr::include_graphics("libs/Images/02_2-IWC_Page1.png")
```
]
...
3. High delegation means no need to waste time/resources on complete contracting
...
.center[.size45[.content-box-white[**Treaty on the Prohibition of Nuclear Weapons (2017)**]]]
