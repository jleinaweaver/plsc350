...
ggplot(data = d3) +
  ...
  labs(fill = "", title = "V-Dem: Freedom from Torture in 2022") +
...
ggplot(data = d3) +
  geom_sf(aes(fill = as.factor(v2cltort_ord))) +
  labs(fill = "", title = "V-Dem: Freedom from Torture in 2025") +
  scale_fill_manual(values = c("#CC2908", "#F788B3", "orange", "#88E3F7", "#4D70F0"))
...
d |>
  ...
  geom_col() +
  scale_fill_manual(values = c("#CC2908", "#F788B3", "orange", "#88E3F7", "#4D70F0")) +
  labs(x = "", y = "Country Count", title = "Global Trends in Torture (V-Dem)", fill = "") +
  theme_bw()
```
...
d |>
  ...
  ggplot(aes(x = year, y = v2cltort_ord)) +
  geom_rect(xmin = 1780, xmax = 2025, ymin = -.1, ymax = .5, fill = "#CC2908") +
  geom_rect(xmin = 1780, xmax = 2025, ymin = .5, ymax = 1.5, fill = "#F788B3") +
  geom_rect(xmin = 1780, xmax = 2025, ymin = 1.5, ymax = 2.5, fill = "orange") +
  geom_rect(xmin = 1780, xmax = 2025, ymin = 2.5, ymax = 3.5, fill = "#88E3F7") +
  geom_rect(xmin = 1780, xmax = 2025, ymin = 3.5, ymax = 4.1, fill = "#4D70F0") +
  geom_line(linewidth = 2) +
  theme_bw() +
  scale_y_continuous(limits = c(0,4), breaks = 0:4) +
  #scale_x_continuous(breaks = seq(1980, 2025, 5)) +
  labs(x = "", title = "CIRIGHTS: Torture in the US") 
```
